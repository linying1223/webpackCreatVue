...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new UglifyJsPlugin({
      test: /\.js($|\?)/i,
      cache: true, // Enable file caching. Default path to cache directory: node_modules/.cache/uglifyjs-webpack-plugin.
      ...
      uglifyOptions: {
        ecma: 7,  // Supported ECMAScript Version (5, 6, 7 or 8). Affects parse, compress && output options
        warnings: false,
        compress: {
          drop_console: false,
          collapse_vars: true,
